...
export default function LocationSearch() {
  return (
    <div className="mt-24 bg-yellow-200 py-14">
      <Container>
        <div className="flex flex-col items-center justify-between w-full gap-10 md:flex-row">
          <div>
            <h2 className="max-w-sm text-4xl font-bold leading-tight md:whitespace-pre">
              Find the right
              <wbr />
              opportunity near you.
            </h2>
            <p className="mt-4 text-xl text-gray-500">
              Find the suitable and best job in your own location
            </p>
            <form action="" method="post">
              <div className="flex flex-col gap-3 mt-14 lg:flex-row">
                <input
                  type="text"
                  className="px-6 py-4 border border-black rounded-full focus:outline-none placeholder:text-black focus-visible:bg-gray-100"
                  placeholder="Postcode / City"
                />
                <select className="px-6 py-4 pr-24 border border-black rounded-full focus:ring-0 focus:border-black focus-visible:outline-none form-select lg:w-72 bg-right-select focus:outline-none placeholder:text-black focus-visible:bg-gray-100">
                ...
                <button
                  type="submit"
                  className="px-12 py-4 text-lg font-medium text-center duration-150 transform border border-black rounded-full bg-emerald-300 hover:border-current hover:bg-white focus:outline-none">
                  Search
                </button>
              </div>
            </form>

export default function SearchLong() {
  return (
    <div>
      <form method="post">
        <div className="flex flex-col w-full gap-4 md:gap-0 md:flex-row">
          <div className="relative flex-1 ">
            ...
            <input
              ...
              className="w-full px-4 py-2 pl-12 border border-black rounded-full lg:w-full md:rounded-none md:rounded-l-full focus:outline-none md:py-4 placeholder:text-black focus-visible:bg-gray-50"
            />
          </div>
          <div className="relative flex-1 ">
            ...
            <input
              ...
              className="w-full px-4 py-2 pl-12 border border-black rounded-full lg:w-full md:rounded-none md:border-l-transparent focus:outline-none md:py-4 placeholder:text-black focus-visible:bg-gray-50"
            />
          </div>
          <div className="  flex-1 ">
            <select
              ...
              id="type"
              defaultValue=""
              className="form-select  w-full px-4 py-2  focus:border-black border border-black rounded-full lg:w-full md:rounded-none md:border-l-transparent md:focus:border-l-transparent  focus:outline-none focus:ring-0 md:py-4 placeholder:text-black focus-visible:bg-gray-50">
          ...
          <button
            type="submit"
            className="py-2 pl-16 pr-20 text-lg font-bold bg-yellow-200 border border-black rounded-full md:rounded-none md:rounded-r-full md:border-l-0">
            Search
          </button>
        </div>
      </form>
